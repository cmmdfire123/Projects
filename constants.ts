...
import { Command, HardwarePart, Song, PhishingTemplate } from './types';
...
export const COMMANDS: Record<string, Command> = {
  // --- OFFENSE ---
  'ping': { id: 'ping', name: 'ping', type: 'atk', val: 5, cost: 1, heat: 2, desc: 'ICMP packet. 5 DMG.' },
  'ssh_crack': { id: 'ssh_crack', name: 'ssh_crack', type: 'atk', val: 12, cost: 3, heat: 10, desc: 'Brute force. 12 DMG.' },
  'sql_inject': { id: 'sql_inject', name: 'sql_inject', type: 'atk', val: 18, cost: 5, heat: 15, desc: 'Drop tables. 18 DMG.' },
  'ddos_flood': { id: 'ddos_flood', name: 'ddos_flood', type: 'atk', val: 25, cost: 8, heat: 25, desc: 'Packet flood. 25 DMG.' },
  'buffer_ovf': { id: 'buffer_ovf', name: 'buffer_ovf', type: 'atk', val: 45, cost: 12, heat: 40, desc: 'Memory exploit. 45 DMG.' },
  'ransomware': { id: 'ransomware', name: 'ransomware', type: 'atk', val: 60, cost: 15, heat: 60, desc: 'Encrypt & Extort. High Heat.' },
  
  // --- DEFENSE/UTIL ---
  'fw_patch': { id: 'fw_patch', name: 'fw_patch', type: 'def', val: 15, cost: 2, heat: 5, desc: 'Shield +15.' },
  'vpn_mask': { id: 'vpn_mask', name: 'vpn_mask', type: 'vpn', val: 0, cost: 5, heat: 5, desc: 'Pause Trace 10s.' },
  'cool_down': { id: 'cool_down', name: 'cool_down', type: 'cool', val: 30, cost: 2, heat: -30, desc: 'Flush Fans. -30 Heat.' },
  'whoami': { id: 'whoami', name: 'whoami', type: 'scan', val: 0, cost: 0, heat: 0, desc: 'Scan target stats.' },
  'wipe_drive': { id: 'wipe_drive', name: 'wipe_drive', type: 'sys', val: 0, cost: 0, heat: 0, desc: 'EMERGENCY WIPE.' },
  'nmap': { id: 'nmap', name: 'nmap', type: 'scan', val: 0, cost: 5, heat: 10, desc: 'Scan subnet for targets.' },

  // --- SHELL ---
  'ls': { id: 'ls', name: 'ls', type: 'shell', cost: 0, heat: 0, desc: 'List files.' },
  'scp': { id: 'scp', name: 'scp', type: 'shell', cost: 0, heat: 0, desc: 'Download file.' },
  'exit': { id: 'exit', name: 'exit', type: 'sys', cost: 0, heat: 0, desc: 'Disconnect.' },
  'help': { id: 'help', name: 'help', type: 'sys', cost: 0, heat: 0, desc: 'Show commands.' },
...
export const STARTING_INVENTORY = ['ping', 'vpn_mask', 'whoami', 'ssh_crack', 'cool_down', 'ls', 'scp', 'exit', 'help', 'ransomware', 'wipe_drive', 'nmap'];

export const ENEMIES = [
  { name: 'Script Kiddie', hp: 30, maxHp: 30, trace: 0, firewall: 0, attacks: ['ping'] },
  { name: 'Corp SysAdmin', hp: 80, maxHp: 80, trace: 0, firewall: 5, attacks: ['ping', 'fw_patch'] },
  { name: 'Gov Mainframe', hp: 200, maxHp: 200, trace: 0, firewall: 15, attacks: ['ssh_crack', 'fw_patch', 'trace_back'] },
];
...
export const SPAM_TEMPLATES = [
    { subject: 'You won a prize!', body: 'CLICK HERE TO CLAIM $1,000,000', sender: 'PrizeBot_9000', difficulty: 1 },
    { subject: 'Security Alert', body: 'Unusual sign-in activity detected.\nVerify your account immediately.', sender: 'Admin_Support', difficulty: 2 },
    { subject: 'Invoice #9923', body: 'Payment overdue. View invoice details attached.', sender: 'Billing_Dept', difficulty: 2 },
    { subject: 'Hot crypto tip', body: 'This coin is going to moon 1000x!!! Buy now!', sender: 'Crypto_King', difficulty: 1 },
    { subject: 'System Update Required', body: 'Critical vulnerability patched. Update your drivers now.', sender: 'Sys_Admin', difficulty: 3 },
    { subject: 'Confidential Job Offer', body: 'We have a special task for you. High pay. No questions.', sender: 'The_Broker', difficulty: 3 },
];
...
export const RIVAL_MESSAGES = {
    low: [{ subject: "Cute setup", body: "I see you." }],
    medium: [{ subject: "Back off", body: "My turf." }],
    high: [{ subject: "WAR", body: "You are dead." }]
};
...
export const MISSION_TEMPLATES = [
    { text: "Retrieve the file.", fileType: "binary" },
];
